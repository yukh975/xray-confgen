...
`,
        ...
        err_dns_server_in_use:  (n) => `This DNS server is used in ${n} rule${n > 1 ? 's' : ''}. Remove those rules first, then delete the server.`,
        ...
        qr_title:                     'Scan to open on another device',
        qr_hint:                      'Link copied to clipboard',
...
`,
        ...
        err_dns_server_in_use:  (n) => `Этот DNS-сервер используется в ${n} правил${n === 1 ? 'е' : 'ах'}. Сначала удалите эти правила, затем удалите сервер.`,
        ...
        qr_title:                     'Отсканируйте на другом устройстве',
        qr_hint:                      'Ссылка скопирована в буфер обмена',
